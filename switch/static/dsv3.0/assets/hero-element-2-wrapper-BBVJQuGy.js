import{i as a,r,g as s,k as c,a as n,j as e}from"./index-C2PWchud.js";import{B as l}from"./base-element-5lxvCIHt.js";/**
@license
...
`;class o extends l{static get styles(){return[r(s),p,a`
            :host {
              display: block;
            }
        ...
        `}static get is(){return"hero-element-2"}}customElements.define(o.is,o);const g=({element:t})=>{const i=n.useRef(null);return n.useEffect(()=>{i.current&&t&&(i.current.e=t)},[t]),e.jsx("div",{children:t?e.jsx("hero-element-2",{id:"hero-element-2",ref:i}):e.jsx("p",{children:"Loading data..."})})};export{g as default};
