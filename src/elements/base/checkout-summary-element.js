...
export class CheckOutSummaryElementBase extends utilsMixin(dataSourceMixin(SerializableElement)){
    ...
    init(pElement, loader) {
        ...
        this.title = CheckOutSummaryElementBase.toTitleCase(pElement.name);
