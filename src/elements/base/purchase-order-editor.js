...
export class PurchaseOrderEditorBase extends ECommerceMixin(dataSourceMixin(utilsMixin(SerializableElement)) ){
    ...
    init(pElement, loader) {
        ...
        this.title = PurchaseOrderEditorBase.toTitleCase(pElement.name);
