...
export const FlexiRadioButtonsBase = class extends utilsMixin(dataSourceMixin(SerializableElement)) {
    ...
    init(pElement, loader) {
        ...
        this.title = FlexiRadioButtonsBase.toTitleCase(pElement.name);
