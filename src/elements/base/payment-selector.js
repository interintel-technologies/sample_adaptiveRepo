...
export const PaymentSelectorBase = class extends utilsMixin( dataSourceMixin(SerializableElement)) {
    ...
    _shouldFilter(items) {
        const b = this._computeItemsCount(items);
        return (b>10);
    }
    ...
    init(pElement, loader) {
        ...
        self.title = PaymentSelectorBase.toTitleCase(pElement.name);
