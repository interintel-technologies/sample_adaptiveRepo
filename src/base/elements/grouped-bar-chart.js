...
export const GroupedBarChartBase = class extends utilsMixin(BaseElement) {
    ...
    firstUpdated(changedProperties) {
        ...
        console.log("this bar chaty ",this.e);
        ...
        this.timeFormat = this.e.details.time_format ? this.e.details.time_format : "%d %b"; 
