...
import {AppointmentElementStyles } from "./appointment-element-css";
import { BaseElement } from "../../core/base-element";
import globalStyles from '../../App.css?raw';

export class AppointmentElement extends BaseElement {
  static get styles() {
    return [
        unsafeCSS(globalStyles),
      AppointmentElementStyles,
      css`
        :host {
          display: block;
        }
                    ...
                    <div class="col-lg-5">
                        <div class="appointment-form">
                            ...
                            <form action="#">
                                ...
                                <a href="#" class="main_btn">Send Message</a>
                            </form>
                        </div>
                    </div>
                </div>
...
customElements.define(AppointmentElement.is, AppointmentElement);
