...
const Navbar8Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-8 id="navbar-8" ref={navbar15ElementRef}></navbar-8>
...
export default withTemplate(Navbar8Wrapper);
