...
const Navbar5Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-5 id="navbar-5" ref={navbar15ElementRef}></navbar-5>
...
export default withTemplate(Navbar5Wrapper);
