...
const Navbar4Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-4 id="navbar-4" ref={navbar15ElementRef}></navbar-4>
...
export default withTemplate(Navbar4Wrapper);
