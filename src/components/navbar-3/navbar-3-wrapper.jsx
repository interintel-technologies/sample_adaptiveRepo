...
const Navbar3Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-3 id="navbar-3" ref={navbar15ElementRef}></navbar-3>
...
export default withTemplate(Navbar3Wrapper);
