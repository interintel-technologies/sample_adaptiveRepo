...
const Navbar11Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-11 id="navbar-11" ref={navbar15ElementRef}></navbar-11>
...
export default withTemplate(Navbar11Wrapper);
