...
const Navbar10Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-10 id="navbar-10" ref={navbar15ElementRef}></navbar-10>
...
export default withTemplate(Navbar10Wrapper);
