...
const Navbar12Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-12 id="navbar-12" ref={navbar15ElementRef}></navbar-12>
...
export default withTemplate(Navbar12Wrapper);
