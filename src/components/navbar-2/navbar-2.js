...
import { NavbarTwoStyles } from './navbar-2-css';
import globalStyles from '../../App.css?raw'


class Navbar2 extends LitElement {
  static get styles() {
    return [
              ...
              <nav class="navbar" role="navigation" aria-label="main navigation">
                ...
                <div id="navbarBasicExample" class="navbar-menu">
                  <div class="navbar-end">
                    ${this.e && this.e.details.groupTitle
                      ? html`
                              ...
                              <div class="columns is-multiline is-mobile mt-3" style="gap:.75rem">
                                ${this.pageGroups && this.pageGroups.length
                                  ? this.pageGroups.map((pageGroup, pageGroupIndex) => html`
                                      ${this.group && this.group.includes(pageGroup._title)
                                        ? html`
                                            ${this.e.details.hide.includes(pageGroup._title)
                                              ? ''
                                              : html`
                    ...
                    ${this.pageGroups && this.pageGroups.length
                      ? this.pageGroups.map((pageGroup, pageGroupIndex) => html`
                          ${this.group &&  this.group.includes(pageGroup._title.replace(/ /g, '-').toLowerCase())
                            ? ''
                            : html`
                                ${this.e.details.hide.includes(pageGroup._title)
                                  ? ''
                                  : html`
                                      ...
                                      ${pageGroup._tabs.map((menu, menuIndex) => html`
                                        ${this.e.details.hide && this.e.details.hide.includes(menu._title)
                                          ? ''
                                          : html`
