...
const Navbar6Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-6 id="navbar-6" ref={navbar15ElementRef}></navbar-6>
...
export default withTemplate(Navbar6Wrapper);
