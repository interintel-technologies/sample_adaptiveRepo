...
const Navbar7Wrapper = ({ element, pageGroups, currentPageGroupName, gatewayData }) => {
    ...
    <>
      {element ? (
        <>
          ...
          <navbar-7 id="navbar-7" ref={navbar15ElementRef}></navbar-7>
...
export default withTemplate(Navbar7Wrapper);
