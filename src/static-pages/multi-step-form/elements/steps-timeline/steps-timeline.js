...
import { StepsTimelineStyles } from './steps-timeline-css';
import {multiStepMixin} from '../../mixins/multiStepMixin.js';

class StepsTimeline extends multiStepMixin(ThemeMixin(LitElement)) {
    ...
    connectedCallback() {
        ...
        this.steps=[{"isActive":true,"id":0},{"isActive":false,"id":1},{"isActive":false,"id":2},{"isActive":false,"id":3}];
